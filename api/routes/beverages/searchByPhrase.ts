      ...
      { $sort: { added: -1 } },
      {
        $match: {
          $or: [
            ...
            { "producer.brewing.style.value": { $regex: new RegExp(phrase, "i") } },
            { "editorial.brewing.style.value": { $regex: new RegExp(phrase, "i") } },
            // Barcode
            ...
            { "produder.general.tale.article": { $regex: new RegExp(phrase, "i") } },
          ],
        },
      },
    ])
